 ...
 */
public class TabPager5 extends BaseCallCarTabPager {
    ...
    public TabPager5(Context context, CallCarPagerBean.DataBean.ChildrenBean childrenData) {
        super(context);
    ...
    public View initView() {
        View view = View.inflate(context, R.layout.callcartab_5,null);
