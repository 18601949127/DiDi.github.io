 ...
 */
public class TabPager0 extends BaseCallCarTabPager {
    ...
    public TabPager0(Context context, CallCarPagerBean.DataBean.ChildrenBean childrenData) {
        super(context);
    ...
    public View initView() {
        LogUtil.i("进入： 类:TabPager0 -----方法:initView()---- ");
        View view = View.inflate(context, R.layout.callcartab_0,null);
    ...
    public void initData() {
        LogUtil.i("进入： 类:TabPager0 -----方法:initData()---- ");
        super.initData();
